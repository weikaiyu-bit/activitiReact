...
class PPassportSearchAddModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    const { id, fileId, name, type, receive, receiveId, receiveOrg, receiveOrgId,
      state, keeper, approval, approvalTime, remark, creatorId, creator, createTime, } = record;
...
export default Form.create()(PPassportSearchAddModal);
