...
class WfWorkflowsAddModal extends Component {
  // constructor(props) {
  //   super(props);
  //   this.state = {
  ...
  render() {
    ...
    const { flowName, flowJson, beginNodeId, endNodeId, remark, pageUrl, catgId } = record
...
export default Form.create()(WfWorkflowsAddModal);
