...
class TalentQuerySearchBar extends Component {
  state = {
    formValues: {},
  ...
  renderAdvancedForm() {
    const { form: { getFieldDecorator } } = this.props;
    const { positionLevel, rankTree, personnelCategoryTree } = this.state;
    const rankData = {
      tree: rankTree,
      type: 'disableParent',
    };
      ...
      <div className="personnelSearchBar" style={{ width: '100%' }}>
        <Form onSubmit={this.handleSearch} layout="horizontal" {...formItemLayout}>
          <Row>
            ...
            <Col md={8} sm={24}>
              <Checkbox
                onClick={() => this.onChangeStart(1)}
                checked={this.state.PeopleState === 1}
              >
                在职人员
              </Checkbox>
              <Checkbox
                onClick={() => this.onChangeStart(2)}
                checked={this.state.PeopleState === 2}
              >
                非在职人员
              </Checkbox>
              <Radio.Group onChange={this.onChangeRadio} defaultValue={this.state.radioNum} >
          ...
          <Row>
            ...
            <Col md={15} sm={24}>
              <FormItem wrapperCol={{ span: 24 }}>
                <label style={{ marginLeft: 2, marginRight: 2 }}>任现职务层次年限：</label>
                <InputNumber />
                <label style={{ marginLeft: 2, marginRight: 2 }}>至</label>
                <InputNumber />
                <label style={{ marginLeft: 2 }}>年</label>
              </FormItem>
            </Col>
          </Row>
          <Row>
          ...
          <Row>
            ...
            <Col span={2}>
              <FormItem label="非中共党员" labelCol={{ span: 13 }}
                wrapperCol={{ span: 2 }}>
          ...
          <Row>
            <Col md={8} sm={24}>
              <FormItem label="年龄" labelCol={{ span: 6 }}
                wrapperCol={{ span: 18 }}>
                <InputNumber />
                <label style={{ marginLeft: 2, marginRight: 2 }}>至</label>
                <InputNumber />
                <label style={{ marginLeft: 2, marginRight: 2 }}>岁</label>
              </FormItem>
            </Col>
            <Col md={7} sm={24}>
              <FormItem label="年龄年限计算截至" labelCol={{ span: 14 }}
                wrapperCol={{ span: 10 }}>
                <InputNumber />
              </FormItem>
            </Col>
          ...
          <Row>
            <Col md={8} sm={24}>
              <FormItem label="人员类别" labelCol={{ span: 8 }} wrapperCol={{ span: 16 }}>
                {getFieldDecorator('personnelCategory')(
                  <DictionaryTree {...personnelCategoryData}/>,
                )}
              </FormItem>
            </Col>
            <Col md={8} sm={24}>
              <FormItem label="职级层次" labelCol={{ span: 8 }} wrapperCol={{ span: 16 }}>
                {getFieldDecorator('rank')(
                  <DictionaryTree {...rankData}/>,
                )}
              </FormItem>
            </Col>
            <Col md={8} sm={24}>
              <FormItem label="职务层次" labelCol={{ span: 8 }} wrapperCol={{ span: 16 }}>
                {getFieldDecorator('positionLevel')(
                  <DictionaryTree {...positionLevelData}/>,
                )}
              </FormItem>
            </Col>
          </Row>
...
export default TalentQuerySearchBar;
