...
const prefix = '/api/oa/admin/v1/RtPerformance';
const rtCategory = '/api/oa/admin/v1/RtCategory';
/*
查找组织结构
 */

export async function listRtCategory (params) {
  return request(`${rtCategory}/find`, {
    method: 'POST',
    data: params,
  });
}
