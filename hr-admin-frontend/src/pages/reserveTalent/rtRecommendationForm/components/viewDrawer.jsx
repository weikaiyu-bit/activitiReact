...
import { Drawer, Row, Form, Col, Upload, Avatar, Tabs } from 'antd';
import { LoadingOutlined, PlusOutlined } from '@ant-design/icons';
import styles from '../css/style.less';
import moment from "moment";

const { TabPane } = Tabs;
class RtRecommendationFormViewDrawer extends Component {
...
export default RtRecommendationFormViewDrawer;
