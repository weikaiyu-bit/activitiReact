...
class CmsInformationSearchBar extends Component {
  state = {
    expandForm: false,
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row style={{ marginBottom: 24 }}>
          <Col md={8} sm={24}>
            <FormItem label="标题">
              {getFieldDecorator('title')(<Input style={{ width: '250px' }} placeholder="标题" />)}
            </FormItem>
          </Col>
          {/* <Col md={8} sm={24} >
            <FormItem label="网站栏目">
          ...
          <Col md={8} sm={24} style={{ marginTop: 38 }}>
            <span>
              <Button
                icon="search"
                type="primary"
...
export default CmsInformationSearchBar;
