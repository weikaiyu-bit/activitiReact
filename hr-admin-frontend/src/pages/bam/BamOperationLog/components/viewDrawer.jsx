...
class BamOperationLogViewDrawer extends Component {
  close = () => {
  ...
  render() {
    ...
    return (
      <Drawer width="40%" visible={visible} onClose={this.close} title="详情信息">
        <Descriptions column={2} bordered>
          ...
          <Descriptions.Item label="请求URI">{data.url}</Descriptions.Item>
...
export default BamOperationLogViewDrawer;
